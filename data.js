...
const LOCATION_POOL = [
  ...
  { id: 'l4',  name: 'The Armory',     effect: 'draw_weapon',  effectDesc: 'Draw weapon card',           icon: '⚔️', css: 'buff'         },
  { id: 'l5',  name: 'The Forge',      effect: 'draw_defense', effectDesc: 'Draw defense card',          icon: '⚒️', css: 'buff'         },
  { id: 'l6',  name: 'Radiation Zone', effect: 'radiation',    effectDesc: '-5 HP per phase here',       icon: '☢️', css: 'danger'       },
  { id: 'l7',  name: 'Stink Swamp',    effect: 'radiation',    effectDesc: '-5 HP per phase here',       icon: '🍄', css: 'danger'       },
  { id: 'l8',  name: 'Scrap Heap',     effect: 'discard',      effectDesc: 'Optionally discard 1 card',  icon: '🗑️', css: 'neutral'      },
  { id: 'l9',  name: 'The Hospital',   effect: 'heal',         effectDesc: '+3 HP per phase here',       icon: '❤️‍🩹', css: 'buff'      },
  ...
  { id: 'l12', name: 'Fire Zone',      effect: 'radiation',    effectDesc: '-5 HP per phase here',       icon: '🔥', css: 'danger'       },
  { id: 'l13', name: 'Supply Depot',   effect: 'draw_weapon',  effectDesc: 'Draw weapon card',           icon: '📦', css: 'buff'         },
  { id: 'l14', name: 'Medic Post',     effect: 'draw_defense', effectDesc: 'Draw defense card',          icon: '🏥', css: 'buff'         },
  ...
  { id: 'l18', name: 'Toxic Waste',    effect: 'radiation',    effectDesc: '-5 HP per phase here',       icon: '☣️', css: 'danger'       },
  { id: 'l19', name: 'Power Station',  effect: 'heal',         effectDesc: '+3 HP per phase here',       icon: '⚡', css: 'buff'         },
