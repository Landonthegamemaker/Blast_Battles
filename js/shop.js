...
const SHOP_SLOTS = ['all', 'hand', 'head', 'chest', 'legs', 'feet', 'arm', 'hips'];
const SHOP_SLOT_LABELS = { all: 'All', hand: 'Hand', head: 'Head', chest: 'Chest', legs: 'Legs', feet: 'Feet', arm: 'Arm', hips: 'Hips' };
...
function _renderShopGrid() {
  ...
  for (const item of items) {
    ...
    // same weapon works, and how footwear pairs work), disabled only when unaffordable.
